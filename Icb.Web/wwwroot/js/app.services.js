System.register(['angular2/core', './services/account', './services/api', './services/modelValidation', './services/storage'], function(exports_1) {
    var core_1, account_1, api_1, modelValidation_1, storage_1;
    var APP_SERVICES;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            exports_1("APP_SERVICES", APP_SERVICES = [
                ...
                core_1.provide(modelValidation_1.ModelValidationService, { useClass: modelValidation_1.ModelValidationService }),
